...
typedef enum {
    ...
    WAVEFORM_MENU_ITEM_CAPTURE_WHOLE_SOURCE,
...
typedef struct App {
    ...
    int64_t timeline_edit_preserved_offset_ticks;
    ...
    TimelineValueBubbleMode timeline_value_bubble_mode;
    TimelineInstanceRef timeline_value_bubble_instance;
